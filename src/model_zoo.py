...
def model1(learning_rate=0.001, lr_decay=1e-6, drop_out=0.2, input_shape=(75, 75, 3)):
    # Build keras model
...
def model2(learning_rate=0.001, lr_decay=1e-6, drop_out=0.2, input_shape=(75, 75, 3)):
    ...
    model = Model(inputs=[X_input, X_inc_angle], outputs=X, name="model2")
...
def model3(learning_rate=0.001, lr_decay=1e-6, drop_out=0.2, input_shape=(75, 75, 3)):
    # define input placeholder as a tensor with the shape input_shape.
    # this shape is the shape of the input "image"
    X_input = Input(input_shape)
    ...
    model = Model(inputs=[X_input, X_inc_angle], outputs=X, name="model3")
...
def model4(learning_rate=0.001, lr_decay=1e-6, drop_out=0.2, input_shape=(75, 75, 3)):
    # define input placeholder as a tensor with the shape input_shape.
    # this shape is the shape of the input "image"
    X_input = Input(input_shape)
    ...
    model = Model(inputs=[X_input, X_inc_angle], outputs=X, name="model4")
...
def tiny_model(drop_out=0.20, learning_rate=0.01, lr_decay=0, input_shape=(75, 75, 3)):
    # define input placeholder as a tensor with the shape input_shape.
    # this shape is the shape of the input "image"
    X_input = Input(input_shape)
    ...
    model = Model(inputs=[X_input, X_inc_angle], outputs=X, name="tiny_model")
...
def model5(learning_rate=0.001, lr_decay=1e-6, drop_out=0.2, input_shape=(75, 75, 3)):
    # define input placeholder as a tensor with the shape input_shape.
    # this shape is the shape of the input "image"
    X_input = Input(input_shape)
    ...
    model = Model(inputs=[X_input, X_inc_angle], outputs=X, name="model5")
